...
import {
  STATION_DAILY_PRECIPITATION_METRICS_COLLECTION_NAME,
  MongoStationDailyPrecipitationMetrics,
} from "#database/mongodb/schemas/station-daily-precipitation-metrics";

@Injectable()
export class MongoDbStationDailyPrecipitationMetricsRepository {
  private db: Db;

  private readonly logger = new Logger(
    MongoDbStationDailyPrecipitationMetricsRepository.name
  );
  ...
  > {
    ...
    try {
      ...
      const collection =
        this.db.collection<MongoStationDailyPrecipitationMetrics>(
          STATION_DAILY_PRECIPITATION_METRICS_COLLECTION_NAME
        );
